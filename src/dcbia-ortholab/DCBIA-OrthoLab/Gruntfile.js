    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            js: {
                ...
                './dcbia-projects/src/*.js',
                './dcbia-plots/src/*.js',
                './dcbia-surveys/src/*.js',
                './jwtUserLogin/src/*.js',
                './dcbia-jobs/src/*.js',
                './nav-bar/src/*.js',
                './node_modules/dcbia-vtk/dist/dcbia-vtk.service.js'],
                tasks: ['run_grunt:dev']
            },
        }
    });
